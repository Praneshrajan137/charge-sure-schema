...
-- Insert sample chargers for these stations with various types and statuses
...
-- Tesla Supercharger - Union Square (STN002) - Tesla exclusive
('CHG002A', 'STN002', 'Tesla', 250, 'Available', NOW() - INTERVAL '1 minute'),
('CHG002B', 'STN002', 'Tesla', 250, 'Available', NOW() - INTERVAL '3 minutes'),
('CHG002C', 'STN002', 'Tesla', 250, 'In Use', NOW() - INTERVAL '15 minutes'),
('CHG002D', 'STN002', 'Tesla', 250, 'In Use', NOW() - INTERVAL '32 minutes'),
...
-- Airport Express Charging (STN005) - Ultra-fast
...
-- Bay Bridge Plaza Chargers (STN006) - Reliable station
...
-- Pacific Heights Premium Station (STN011) - High-end area
('CHG011A', 'STN011', 'CCS', 250, 'Available', NOW() - INTERVAL '1 minute'),
('CHG011B', 'STN011', 'Tesla', 250, 'Available', NOW() - INTERVAL '3 minutes'),

-- Fisherman''s Wharf Charging (STN012) - Tourist area
